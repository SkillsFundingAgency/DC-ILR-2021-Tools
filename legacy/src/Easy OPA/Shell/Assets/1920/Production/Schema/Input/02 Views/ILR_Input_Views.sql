...
if object_id('Input.LearnerDenorm','V') is not null
begin
	drop VIEW Input.LearnerDenorm
end
go

create view Input.LearnerDenorm
as
...
if object_id('Input.LearnerEmploymentStatusDenorm','V') is not null
begin
	drop VIEW Input.LearnerEmploymentStatusDenorm
end
go

create view Input.LearnerEmploymentStatusDenorm
as
...
if object_id('Input.LearningDeliveryDenorm','V') is not null
begin
	drop VIEW Input.LearningDeliveryDenorm
end
go

create view Input.LearningDeliveryDenorm
as
...
if object_id('Input.PostcodesList','V') is not null
begin
	drop view Input.PostcodesList
end
go

create view Input.PostcodesList
as
	--Get all postcodes from all entities in to a single list in preparation for Populate Reference Data Task
	select	LSDPostcode as Postcode
	from	Input.LearningDelivery		

	union
	select	DelLocPostCode as Postcode
	from	Input.LearningDelivery		

	union
	select	HEPostCode as Postcode
	...
	union
	select	PostcodePrior as Postcode
	from	Input.Learner
go
