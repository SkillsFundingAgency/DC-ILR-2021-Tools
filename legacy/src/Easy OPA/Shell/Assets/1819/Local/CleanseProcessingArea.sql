...
as
begin
	-- the presence of this table will indicate a full build has taken place
	...
	truncate table Rulebase.FM25_FM35_Cases
	truncate table Rulebase.FM25_FM35_global
	truncate table Rulebase.FM25_FM35_Learner_Period
	truncate table Rulebase.FM25_FM35_Learner_PeriodisedValues
	truncate table Rulebase.FM25_Cases
	truncate table Rulebase.FM25_global
	truncate table Rulebase.FM25_Learner
	...
	truncate table Rulebase.FM35_Cases
	truncate table Rulebase.FM35_global
	truncate table Rulebase.FM35_LearningDelivery
	truncate table Rulebase.FM35_LearningDeliveryPeriod
	truncate table Rulebase.FM35_LearningDelivery_Period
	truncate table Rulebase.FM35_LearningDelivery_PeriodisedValues
