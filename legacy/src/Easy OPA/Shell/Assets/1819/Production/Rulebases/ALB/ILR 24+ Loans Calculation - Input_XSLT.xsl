                                        ...
                                        <xsl:for-each select="LearningDelivery">
                                            ...
                                            <instance>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:attribute name="id">SubsidyPilotPostcodeArea</xsl:attribute>
                                                    <xsl:attribute name="complete">
                                                        <xsl:value-of select="string(((normalize-space('true') = 'true') or (normalize-space('true') = '1')))"/>
                                                    </xsl:attribute>
                                                    <xsl:for-each select="SubsidyPilotPostcodeArea">
                                                        <xsl:variable name="var_SubsidyPilotAreaCode"
                                                                      select="@SubsidyPilotAreaCode"/>
                                                        <xsl:variable name="var_SubsidyPilotEffectiveFrom"
                                                                      select="@SubsidyPilotEffectiveFrom"/>
                                                        <xsl:variable name="var_SubsidyPilotEffectiveTo"
                                                                      select="@SubsidyPilotEffectiveTo"/>
                                                        <instance>
                                                            <xsl:attribute name="id">
                                                                <xsl:value-of select="generate-id(.)"/>
                                                            </xsl:attribute>
                                                            <xsl:if test="string(boolean($var_SubsidyPilotAreaCode)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">SubsidyPilotAreaCode</xsl:attribute>
                                                                    <text-val>
                                                                        <xsl:value-of select="string($var_SubsidyPilotAreaCode)"/>
                                                                    </text-val>
                                                                </attribute>
                                                            </xsl:if>
                                                            <xsl:if test="string(boolean($var_SubsidyPilotEffectiveFrom)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">SubsidyPilotEffectiveFrom</xsl:attribute>
                                                                    <date-val>
                                                                        <xsl:value-of select="string($var_SubsidyPilotEffectiveFrom)"/>
                                                                    </date-val>
                                                                </attribute>
                                                            </xsl:if>
                                                            <xsl:if test="string(boolean($var_SubsidyPilotEffectiveTo)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">SubsidyPilotEffectiveTo</xsl:attribute>
                                                                    <date-val>
                                                                        <xsl:value-of select="string($var_SubsidyPilotEffectiveTo)"/>
                                                                    </date-val>
                                                                </attribute>
                                                            </xsl:if>
                                                        </instance>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:attribute name="id">LARS_CareerLearningPilot</xsl:attribute>
                                                    <xsl:attribute name="complete">
                                                        <xsl:value-of select="string(((normalize-space('true') = 'true') or (normalize-space('true') = '1')))"/>
                                                    </xsl:attribute>
                                                    <xsl:for-each select="LARS_CareerLearningPilot">
                                                        <xsl:variable name="var_LearnDelLARSCarPilFundAreaCode"
                                                                      select="@LearnDelLARSCarPilFundAreaCode"/>
                                                        <xsl:variable name="var_LearnDelLARSCarPilFundEffFromDate"
                                                                      select="@LearnDelLARSCarPilFundEffFromDate"/>
                                                        <xsl:variable name="var_LearnDelLARSCarPilFundEffToDate"
                                                                      select="@LearnDelLARSCarPilFundEffToDate"/>
                                                        <xsl:variable name="var_LearnDelLARSCarPilFundSubsidyRate"
                                                                      select="@LearnDelLARSCarPilFundSubsidyRate"/>
                                                        <instance>
                                                            <xsl:attribute name="id">
                                                                <xsl:value-of select="generate-id(.)"/>
                                                            </xsl:attribute>
                                                            <xsl:if test="string(boolean($var_LearnDelLARSCarPilFundAreaCode)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">LearnDelLARSCarPilFundAreaCode</xsl:attribute>
                                                                    <text-val>
                                                                        <xsl:value-of select="string($var_LearnDelLARSCarPilFundAreaCode)"/>
                                                                    </text-val>
                                                                </attribute>
                                                            </xsl:if>
                                                            <xsl:if test="string(boolean($var_LearnDelLARSCarPilFundEffFromDate)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">LearnDelLARSCarPilFundEffFromDate</xsl:attribute>
                                                                    <date-val>
                                                                        <xsl:value-of select="string($var_LearnDelLARSCarPilFundEffFromDate)"/>
                                                                    </date-val>
                                                                </attribute>
                                                            </xsl:if>
                                                            <xsl:if test="string(boolean($var_LearnDelLARSCarPilFundEffToDate)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">LearnDelLARSCarPilFundEffToDate</xsl:attribute>
                                                                    <date-val>
                                                                        <xsl:value-of select="string($var_LearnDelLARSCarPilFundEffToDate)"/>
                                                                    </date-val>
                                                                </attribute>
                                                            </xsl:if>
                                                            <xsl:if test="string(boolean($var_LearnDelLARSCarPilFundSubsidyRate)) != 'false'">
                                                                <attribute>
                                                                    <xsl:attribute name="id">LearnDelLARSCarPilFundSubsidyRate</xsl:attribute>
                                                                    <number-val>
                                                                        <xsl:value-of select="string($var_LearnDelLARSCarPilFundSubsidyRate)"/>
                                                                    </number-val>
                                                                </attribute>
                                                            </xsl:if>
                                                        </instance>
