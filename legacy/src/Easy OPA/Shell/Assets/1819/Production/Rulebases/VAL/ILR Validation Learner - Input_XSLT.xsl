            ...
            <entity>
                ...
                <xsl:for-each select="global">
                    ...
                    <xsl:variable name="var_LARSVersion"
                                  select="@LARSVersion"/>
                    <xsl:variable name="var_LegalOrgType"
                                  select="@LegalOrgType"/>
                    <xsl:variable name="var_DesktopMode"
                                  select="@DesktopMode"/>
                    <xsl:variable name="var_FCT_ESF1420"
                                  select="@FCT_ESF1420"/>
                    <xsl:variable name="var_FCT_LEVY1799"
                                  select="@FCT_LEVY1799"/>
                    <xsl:variable name="var_FCT_16-18NLAP2018"
                                  select="@FCT_16-18NLAP2018"/>
                    <xsl:variable name="var_FCT_ALLBC1819"
                                  select="@FCT_ALLBC1819"/>
                    <xsl:variable name="var_FCT_AEBC1819"
                                  select="@FCT_AEBC1819"/>
                    <xsl:variable name="var_FCT_APPS1819"
                                  select="@FCT_APPS1819"/>
                    <xsl:variable name="var_FCT_ANLAP2018"
                                  select="@FCT_ANLAP2018"/>
                    <xsl:variable name="var_FCT_ALLB1819"
                                  select="@FCT_ALLB1819"/>
                    <xsl:variable name="var_FCT_AEB-TOL1819"
                                  select="@FCT_AEB-TOL1819"/>
                    <instance>
                        <xsl:attribute name="id">
                            <xsl:value-of select="generate-id(.)"/>
                        </xsl:attribute>
                        ...
                        <xsl:if test="string(boolean($var_FCT_ALLBC1819)) != 'false'">
                            <attribute>
                                <xsl:attribute name="id">FCT_ALLBC1819</xsl:attribute>
                                <boolean-val>
                                    <xsl:value-of select="string($var_FCT_ALLBC1819)"/>
                                </boolean-val>
                            </attribute>
                        </xsl:if>
                        <xsl:if test="string(boolean($var_FCT_AEBC1819)) != 'false'">
                            <attribute>
                                <xsl:attribute name="id">FCT_AEBC1819</xsl:attribute>
                                <boolean-val>
                                    <xsl:value-of select="string($var_FCT_AEBC1819)"/>
                                </boolean-val>
                            </attribute>
                        </xsl:if>
                        <xsl:if test="string(boolean($var_FCT_APPS1819)) != 'false'">
                            <attribute>
                                <xsl:attribute name="id">FCT_APPS1819</xsl:attribute>
                                <boolean-val>
                                    <xsl:value-of select="string($var_FCT_APPS1819)"/>
                                </boolean-val>
                            </attribute>
                        </xsl:if>
                        ...
                        <xsl:if test="string(boolean($var_FCT_ALLB1819)) != 'false'">
                            <attribute>
                                <xsl:attribute name="id">FCT_ALLB1819</xsl:attribute>
                                <boolean-val>
                                    <xsl:value-of select="string($var_FCT_ALLB1819)"/>
                                </boolean-val>
                            </attribute>
                        </xsl:if>
                        <xsl:if test="string(boolean($var_FCT_AEB-TOL1819)) != 'false'">
                            <attribute>
                                <xsl:attribute name="id">FCT_AEB-TOL1819</xsl:attribute>
                                <boolean-val>
                                    <xsl:value-of select="string($var_FCT_AEB-TOL1819)"/>
                                </boolean-val>
                            </attribute>
                        </xsl:if>
                        <entity>
                            ...
                            <xsl:for-each select="Learner">
                                ...
                                <xsl:variable name="var_DateOfBirth"
                                              select="@DateOfBirth"/>
                                <xsl:variable name="var_Accom"
                                              select="@Accom"/>
                                <xsl:variable name="var_FamilyName"
                                              select="@FamilyName"/>
                                <xsl:variable name="var_GivenNames"
                                              select="@GivenNames"/>
                                <xsl:variable name="var_LLDDHealthProb"
                                              select="@LLDDHealthProb"/>
                                <xsl:variable name="var_NINumber"
                                              select="@NINumber"/>
                                ...
                                <xsl:variable name="var_ULN"
                                              select="@ULN"/>
                                <xsl:variable name="var_Sex"
                                              select="@Sex"/>
                                <xsl:variable name="var_EngGrade"
                                              select="@EngGrade"/>
                                <xsl:variable name="var_MathGrade"
                                              select="@MathGrade"/>
                                <xsl:variable name="var_ALSCost"
                                              select="@ALSCost"/>
                                <xsl:variable name="var_PMUKPRN"
                                              select="@PMUKPRN"/>
                                <xsl:variable name="var_PostcodePrior"
                                              select="@PostcodePrior"/>
                                <xsl:variable name="var_Postcode"
                                              select="@Postcode"/>
                                <xsl:variable name="var_AddLine1"
                                              select="@AddLine1"/>
                                <xsl:variable name="var_CampId"
                                              select="@CampId"/>
                                <xsl:variable name="var_MasterUKPRN"
                                              select="@MasterUKPRN"/>
                                <xsl:variable name="var_ULNLookup"
                                              select="@ULNLookup"/>
                                <xsl:variable name="var_PrevUKPRNLookup"
                                              select="@PrevUKPRNLookup"/>
                                <xsl:variable name="var_PostCodePriorLookup"
                                              select="@PostCodePriorLookup"/>
                                <xsl:variable name="var_PostcodeLookUp"
                                              select="@PostcodeLookUp"/>
                                <xsl:variable name="var_PMUKPRNLookUp"
                                              select="@PMUKPRNLookUp"/>
                                <xsl:variable name="var_CampIdLookup"
                                              select="@CampIdLookup"/>
                                <instance>
                                    <xsl:attribute name="id">
                                        <xsl:value-of select="generate-id(.)"/>
                                    ...
                                    <xsl:if test="string(boolean($var_CampId)) != 'false'">
                                        <attribute>
                                            <xsl:attribute name="id">CampId</xsl:attribute>
                                            <text-val>
                                                <xsl:value-of select="$var_CampId"/>
                                            </text-val>
                                        </attribute>
                                    </xsl:if>
                                    <xsl:if test="string(boolean($var_MasterUKPRN)) != 'false'">
                                        <attribute>
                                            <xsl:attribute name="id">MasterUKPRN</xsl:attribute>
                                            <number-val>
                                                <xsl:value-of select="$var_MasterUKPRN"/>
                                            </number-val>
                                        </attribute>
                                    </xsl:if>
                                    ...
                                    <xsl:if test="string(boolean($var_CampIdLookup)) != 'false'">
                                        <attribute>
                                            <xsl:attribute name="id">CampIdLookup</xsl:attribute>
                                            <boolean-val>
                                                <xsl:value-of select="$var_CampIdLookup"/>
                                            </boolean-val>
                                        </attribute>
                                    </xsl:if>
                                    <entity>
                                        ...
                                        <xsl:for-each select="LearningDelivery">
                                            ...
                                            <xsl:variable name="var_AchDate"
                                                          select="@AchDate"/>
                                            <xsl:variable name="var_Section96ReviewDate"
                                                          select="@Section96ReviewDate"/>
                                            <xsl:variable name="var_Section96ApprovalStatus"
                                                          select="@Section96ApprovalStatus"/>
                                            ...
                                            <xsl:variable name="var_FrameworkAimEffectiveTo"
                                                          select="@FrameworkAimEffectiveTo"/>
                                            <xsl:variable name="var_OrigLearnStartDate"
                                                          select="@OrigLearnStartDate"/>
                                            <xsl:variable name="var_FrameworkPathwayEffectiveTo"
                                                          select="@FrameworkPathwayEffectiveTo"/>
                                            <xsl:variable name="var_LDCS1Code"
                                                          select="@LDCS1Code"/>
                                            <xsl:variable name="var_SWSupAimId"
                                                          select="@SWSupAimId"/>
                                            <xsl:variable name="var_AwardOrgAimRef"
                                                          select="@AwardOrgAimRef"/>
                                            ...
                                            <xsl:variable name="var_LARS_EnglPrscID"
                                                          select="@LARS_EnglPrscID"/>
                                            <xsl:variable name="var_LARS_LearningDeliveryGenre"
                                                          select="@LARS_LearningDeliveryGenre"/>
                                            <xsl:variable name="var_StdCode"
                                                          select="@StdCode"/>
                                            <xsl:variable name="var_StandardEffectiveTo"
                                                          select="@StandardEffectiveTo"/>
                                            <xsl:variable name="var_EPAOrgId"
                                                          select="@EPAOrgId"/>
                                            <xsl:variable name="var_PartnerUKPRNLookup"
                                                          select="@PartnerUKPRNLookup"/>
                                            <xsl:variable name="var_LearnAimRefLookup"
                                                          select="@LearnAimRefLookup"/>
                                            <xsl:variable name="var_FrameworkAimLookup"
                                                          select="@FrameworkAimLookup"/>
                                            <xsl:variable name="var_FrameworkLookup"
                                                          select="@FrameworkLookup"/>
                                            <xsl:variable name="var_FrameworkCommonLookup"
                                                          select="@FrameworkCommonLookup"/>
                                            <xsl:variable name="var_FrameworkPathwayLookup"
                                                          select="@FrameworkPathwayLookup"/>
                                            <xsl:variable name="var_DelLocPostcodeLookup"
                                                          select="@DelLocPostcodeLookup"/>
                                            <xsl:variable name="var_UnemployedOnly"
                                                          select="@UnemployedOnly"/>
                                            <xsl:variable name="var_ConRefNumberValidLookUP"
                                                          select="@ConRefNumberValidLookUP"/>
                                            <xsl:variable name="var_LARS_CategoryRef9"
                                                          select="@LARS_CategoryRef9"/>
                                            <xsl:variable name="var_StandardCodeLookup"
                                                          select="@StandardCodeLookup"/>
                                            <xsl:variable name="var_EPAIDLookup"
                                                          select="@EPAIDLookup"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:for-each select="LearningDeliveryHE">
                                                        <xsl:variable name="var_FUNDLEV"
                                                                      select="@FUNDLEV"/>
                                                        <xsl:variable name="var_QUALENT3"
                                                                      select="@QUALENT3"/>
                                                        <xsl:variable name="var_PCFLDCS"
                                                                      select="@PCFLDCS"/>
                                                        <xsl:variable name="var_PCSLDCS"
                                                                      select="@PCSLDCS"/>
                                                        <xsl:variable name="var_TYPEYR"
                                                                      select="@TYPEYR"/>
                                                        <xsl:variable name="var_MODESTUD"
                                                                      select="@MODESTUD"/>
                                                        <xsl:variable name="var_STULOAD"
                                                                      select="@STULOAD"/>
                                                        <xsl:variable name="var_MSTUFEE"
                                                                      select="@MSTUFEE"/>
                                                        <xsl:variable name="var_NETFEE"
                                                                      select="@NETFEE"/>
                                                        <xsl:variable name="var_PCTLDCS"
                                                                      select="@PCTLDCS"/>
                                                        <xsl:variable name="var_NUMHUS"
                                                                      select="@NUMHUS"/>
                                                        <xsl:variable name="var_SPECFEE"
                                                                      select="@SPECFEE"/>
                                                        <xsl:variable name="var_SSN"
                                                                      select="@SSN"/>
                                                        <xsl:variable name="var_FUNDCOMP"
                                                                      select="@FUNDCOMP"/>
                                                        <xsl:variable name="var_SEC"
                                                                      select="@SEC"/>
                                                        <xsl:variable name="var_DOMICILE"
                                                                      select="@DOMICILE"/>
                                                        <xsl:variable name="var_UCASAPPID"
                                                                      select="@UCASAPPID"/>
                                                        <xsl:variable name="var_PCOLAB"
                                                                      select="@PCOLAB"/>
                                                        <xsl:variable name="var_SOC2000"
                                                                      select="@SOC2000"/>
                                                        <xsl:variable name="var_ELQ"
                                                                      select="@ELQ"/>
                                                        <xsl:variable name="var_GROSSFEE"
                                                                      select="@GROSSFEE"/>
                                                        <xsl:variable name="var_HEPostCode"
                                                                      select="@HEPostCode"/>
                                                        <xsl:variable name="var_HEPostCodeLookup"
                                                                      select="@HEPostCodeLookup"/>
                                                        <instance>
                                                            <xsl:attribute name="id">
                                                                <xsl:value-of select="generate-id(.)"/>
                                                            </xsl:attribute>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:for-each select="ProviderSpecDeliveryMonitoring">
                                                        <xsl:variable name="var_ProvSpecDelMonOccur"
                                                                      select="@ProvSpecDelMonOccur"/>
                                                        <xsl:variable name="var_ProvSpecDelMon"
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:for-each select="LearningDeliveryWorkPlacement">
                                                        <xsl:variable name="var_WorkPlaceEmpId"
                                                                      select="@WorkPlaceEmpId"/>
                                                        <xsl:variable name="var_WorkPlaceMode"
                                                                      select="@WorkPlaceMode"/>
                                                        <xsl:variable name="var_WorkPlaceEndDate"
                                                                      select="@WorkPlaceEndDate"/>
                                                        <xsl:variable name="var_WorkPlaceStartDate"
                                                                      select="@WorkPlaceStartDate"/>
                                                        <xsl:variable name="var_WorkPlaceEmpIdLookup"
                                                                      select="@WorkPlaceEmpIdLookup"/>
                                                        <instance>
                                                            <xsl:attribute name="id">
                                                                <xsl:value-of select="generate-id(.)"/>
                                                            </xsl:attribute>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:for-each select="LearningDeliveryLARSCategory">
                                                        <xsl:variable name="var_LARSCategoryRef"
                                                                      select="@LARSCategoryRef"/>
                                                        <xsl:variable name="var_TopLevelLARSCategoryRef"
                                                                      select="@TopLevelLARSCategoryRef"/>
                                                        <xsl:variable name="var_ParentLARSCategoryRef"
                                                                      select="@ParentLARSCategoryRef"/>
                                                        <instance>
                                                            <xsl:attribute name="id">
                                                                <xsl:value-of select="generate-id(.)"/>
                                                            </xsl:attribute>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:for-each select="LearningDeliveryLARSStandardFunding">
                                                        <xsl:variable name="var_CoreGovContributionCap"
                                                                      select="@CoreGovContributionCap"/>
                                                ...
                                                <entity>
                                                    ...
                                                    <xsl:attribute name="id">LearningDeliveryLARSStandard</xsl:attribute>
                                                    <xsl:attribute name="complete">
                                                        <xsl:value-of select="string(((normalize-space('true')) = ('true') or (normalize-space('true') = '1')))"/>
                                                    </xsl:attribute>
                                                    <xsl:for-each select="LearningDeliveryLARSStandard">
                                                        ...
                                                        <instance>
                                                            ...
                                                            <xsl:if test="string(boolean($var_EffectiveFrom)) != 'false'">
                                                                <attribute>
                                                                    ...
                                                                    <date-val>
                                                                        <xsl:value-of select="$var_EffectiveFrom"/>
                                                                    </date-val>
                                                                </attribute>
                                                            </xsl:if>
                                                        </instance>
                                    ...
                                    <entity>
                                        ...
                                        <xsl:for-each select="LearnerFAM">
                                            <xsl:variable name="var_LearnFAMCode"
                                                          select="@LearnFAMCode"/>
                                            <xsl:variable name="var_LearnFAMType"
                                                          select="@LearnFAMType"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                    ...
                                    <entity>
                                        ...
                                        <xsl:for-each select="LearnerEmploymentStatus">
                                            ...
                                            <xsl:variable name="var_EmpIdLookup"
                                                          select="@EmpIdLookup"/>
                                            <xsl:variable name="var_AgreeIdLookup"
                                                          select="@AgreeIdLookup"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                                </xsl:attribute>
                                                ...
                                                <xsl:if test="string(boolean($var_AgreeIdLookup)) != 'false'">
                                                    <attribute>
                                                        <xsl:attribute name="id">AgreeIdLookup</xsl:attribute>
                                                        <boolean-val>
                                                            <xsl:value-of select="string($var_AgreeIdLookup)"/>
                                                        </boolean-val>
                                                    </attribute>
                                                </xsl:if>
                                                <entity>
                                    ...
                                    <entity>
                                        ...
                                        <xsl:for-each select="LearnerHE">
                                            <xsl:variable name="var_TTACCOM"
                                                          select="@TTACCOM"/>
                                            <xsl:variable name="var_UCASPERID"
                                                          select="@UCASPERID"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                    ...
                                    <entity>
                                        ...
                                        <xsl:for-each select="ProviderSpecLearnerMonitoring">
                                            <xsl:variable name="var_ProvSpecLearnMonOccur"
                                    ...
                                    <entity>
                                        ...
                                        <xsl:for-each select="LearnerDestinationAndProgression">
                                            <xsl:variable name="var_DP_LearnRefNumber"
                                                          select="@DP_LearnRefNumber"/>
                                            <xsl:variable name="var_DP_ULN"
                                                          select="@DP_ULN"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                    ...
                                    <entity>
                                        ...
                                        <xsl:attribute name="id">ContractAllocation</xsl:attribute>
                                        <xsl:attribute name="complete">
                                            <xsl:value-of select="string(((normalize-space('true') = 'true') or (normalize-space('true') = '1')))"/>
                                        </xsl:attribute>
                                        <xsl:for-each select="ContractAllocation">
                                            <xsl:variable name="var_ContractAllocationNumber"
                                                          select="@ContractAllocationNumber"/>
                                            <xsl:variable name="var_FundingStreamPeriodCode"
                                                          select="@FundingStreamPeriodCode"/>
                                            <xsl:variable name="var_StopNewStartsFromDate"
                                                          select="@StopNewStartsFromDate"/>
                                            <instance>
                                                <xsl:attribute name="id">
                                                    <xsl:value-of select="generate-id(.)"/>
                                                </xsl:attribute>
                                                <xsl:if test="string(boolean($var_ContractAllocationNumber)) != 'false'">
                                                    <attribute>
                                                        <xsl:attribute name="id">ContractAllocationNumber</xsl:attribute>
                                                        <text-val>
                                                            <xsl:value-of select="string($var_ContractAllocationNumber)"/>
                                                        </text-val>
                                                    </attribute>
                                                </xsl:if>
                                                <xsl:if test="string(boolean($var_FundingStreamPeriodCode)) != 'false'">
                                                    <attribute>
                                                        <xsl:attribute name="id">FundingStreamPeriodCode</xsl:attribute>
                                                        <text-val>
                                                            <xsl:value-of select="string($var_FundingStreamPeriodCode)"/>
                                                        </text-val>
                                                    </attribute>
                                                </xsl:if>
                                                <xsl:if test="string(boolean($var_StopNewStartsFromDate)) != 'false'">
                                                    <attribute>
                                                        <xsl:attribute name="id">StopNewStartsFromDate</xsl:attribute>
                                                        <date-val>
                                                            <xsl:value-of select="string($var_StopNewStartsFromDate)"/>
                                                        </date-val>
                                                    </attribute>
                                                </xsl:if>
                                            </instance>
