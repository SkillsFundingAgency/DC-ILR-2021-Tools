...
as
	select	g.UKPRN,
			...
			ldp.[LearnDelCarLearnPilotOnProgPayment],
			ldp.[LearnDelCarLearnPilotBalPayment]
...
as
	select	g.UKPRN,
			...
			ld.PlannedNumOnProgInstalm,
			ld.WeightedRate,
			ld.[LearnDelEligCareerLearnPilot] ,
			ld.[LearnDelApplicSubsidyPilotAreaCode],
			ld.[LearnDelApplicLARSCarPilFundSubRate],
			ld.[LearnDelCarLearnPilotAimValue] ,
			ld.[LearnDelCarLearnPilotInstalAmount]
