...
create procedure Rulebase.AEC_Insert_Cases (
	@ReturnPeriod varchar(5)
) as
begin
	set nocount on
...
create procedure Rulebase.AEC_Insert_LearningDelivery (
	...
	@Completed bit = null,
	@DisadvFirstPayment decimal(12,5) = null,							-- not on table, periodised
	@DisadvSecondPayment decimal(12,5) = null,							-- not on table, periodised
	@DisUpFactAdj decimal(10,4) = null,									-- not on table, periodised
	@FirstIncentiveThresholdDate date = null,
	@FundLineType varchar(60) = null,
	@FundStart bit = null,
	@InstPerPeriod int = null,
	@LDApplic1618FrameworkUpliftBalancingPayment decimal(12,5) = null,	-- not on table, periodised
	@LDApplic1618FrameworkUpliftBalancingValue decimal(12,5) = null,
	@LDApplic1618FrameworkUpliftCompElement decimal(12,5) = null,
	@LDApplic1618FrameworkUpliftCompletionPayment decimal(12,5) = null,	-- not on table, periodised
	@LDApplic1618FRameworkUpliftCompletionValue decimal(12,5) = null,
	@LDApplic1618FrameworkUpliftMonthInstalVal decimal(12,5) = null,
	@LDApplic1618FrameworkUpliftOnProgPayment decimal(12,5) = null,		-- not on table, periodised
	...
	@LearnDelApplicTot1618Incentive decimal(12,5) = null,
	...
	@LearnDelFirstEmp1618Pay decimal(12,5) = null,						-- not on table, periodised
	@LearnDelFirstProv1618Pay decimal(12,5) = null,						-- not on table, periodised
	...
	@LearnDelSecondEmp1618Pay decimal(12,5) = null,						-- not on table, periodised
	@LearnDelSecondProv1618Pay decimal(12,5) = null,					-- not on table, periodised
	@LearnDelSEMContWaiver bit = null,
	@LearnDelSFAContribPct decimal(12,5) = null,						-- not on table, periodised
	@LearnSuppFund bit = null,
	@LearnSuppFundCash decimal(12,5) = null,							-- not on table, periodised
	@MathEngAimValue decimal(12,5) = null,
	@MathEngBalPayment decimal(12,5) = null,
	@MathEngBalPct decimal(12,5) = null,								-- not on table, periodised
	@MathEngOnProgPayment decimal(12,5) = null,							-- not on table, periodised
	@MathEngOnProgPct decimal(12,5) = null,								-- not on table, periodised
	@OutstandNumOnProgInstalm int = null,
	@PlannedNumOnProgInstalm int = null,
	@PlannedTotalDaysIL int = null,
	@ProgrammeAimBalPayment	decimal(12,5) = null,						-- not on table, periodised
	@ProgrammeAimCompletionPayment decimal(12,5) = null,				-- not on table, periodised
	@ProgrammeAimOnProgPayment decimal(12,5) = null,					-- not on table, periodised
