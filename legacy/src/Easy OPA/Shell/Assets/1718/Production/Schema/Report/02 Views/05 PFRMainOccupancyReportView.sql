...
SELECT DISTINCT
    ...
    ,EFA_L.[NatRate]											AS [Applicable funding rate]										 
	...
	,[EFA_L].[LearnerStartDate]									AS [Learning start date] 
    ,[EFA_L].[LearnerPlanEndDate]								AS [Learning planned end date] 
    ,NULL														AS [Completion status] 
    ,[EFA_L].[LearnerActEndDate]								AS [Learning actual end date] 
    ,NULL														AS [Outcome] 
    ...
    ,[EFA_L].[FundLine]											AS [Funding line type]
...
LEFT JOIN [Rulebase].[EFA_Learner] AS [EFA_L] ON EFA_L.LearnRefNumber = LD.LearnRefNumber  
