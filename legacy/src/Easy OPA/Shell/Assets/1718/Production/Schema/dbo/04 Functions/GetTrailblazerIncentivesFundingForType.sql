IF OBJECT_ID('GetTrailblazerIncentivesFundingForType') IS NOT NULL
BEGIN
    DROP FUNCTION  GetTrailblazerIncentivesFundingForType
END
GO

CREATE FUNCTION GetTrailblazerIncentivesFundingForType (@learnerType VARCHAR(MAX), @collectionPeriod int)
RETURNS TABLE 
AS 
RETURN
(
