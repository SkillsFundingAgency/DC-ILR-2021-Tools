    ...
    <session-data>
      ...
      <entity>
        ...
        <xsl:for-each select="global">
          <xsl:variable name="var_AreaCostFactor1618" select="@AreaCostFactor1618"/>
          <xsl:variable name="var_DisadvantageProportion" select="@DisadvantageProportion"/>
          <xsl:variable name="var_HistoricLargeProgrammeProportion" select="@HistoricLargeProgrammeProportion"/>
          ...
          <xsl:variable name="var_ProgrammeWeighting" select="@ProgrammeWeighting"/>
          <xsl:variable name="var_RetentionFactor" select="@RetentionFactor"/>
          ...
          <instance>
            ...
            <entity>
              ...
              <xsl:for-each select="Learner">
                ...
                <xsl:variable name="var_LrnFAM_ECF" select="@LrnFAM_ECF"/>
                <xsl:variable name="var_LrnFAM_EDF1" select="@LrnFAM_EDF1"/>
                <xsl:variable name="var_LrnFAM_EDF2" select="@LrnFAM_EDF2"/>
                <xsl:variable name="var_LrnFAM_EHC" select="@LrnFAM_EHC"/>
                <xsl:variable name="var_LrnFAM_HNS" select="@LrnFAM_HNS"/>
                <xsl:variable name="var_LrnFAM_LDA" select="@LrnFAM_LDA"/>
                <xsl:variable name="var_LrnFAM_MCF" select="@LrnFAM_MCF"/>
                ...
                <xsl:variable name="var_PostcodeDisadvantageUplift" select="@PostcodeDisadvantageUplift"/>
                ...
                <instance>
                  ...
                  <xsl:if test="string(boolean($var_LrnFAM_LDA)) != 'false'">
                    <attribute>
                      <xsl:attribute name="id">LrnFAM_LDA</xsl:attribute>
                      <number-val>
                        <xsl:value-of select="string($var_LrnFAM_LDA)"/>
                      </number-val>
                    </attribute>
                  </xsl:if>
                  ...
                  <entity>
                    ...
                    <xsl:for-each select="LearningDelivery">
                      ...
                      <xsl:variable name="var_AwardOrgCode" select="@AwardOrgCode"/>
                      <xsl:variable name="var_CompStatus" select="@CompStatus"/>
                      <xsl:variable name="var_EFACOFType" select="@EFACOFType"/>
                      ...
                      <xsl:variable name="var_LearnAimRefTitle" select="@LearnAimRefTitle"/>
                      ...
                      <xsl:variable name="var_LrnDelFAM_LDM1" select="@LearnDelFAM_LDM1"/>
                      <xsl:variable name="var_LrnDelFAM_LDM2" select="@LearnDelFAM_LDM2"/>
                      <xsl:variable name="var_LrnDelFAM_LDM3" select="@LearnDelFAM_LDM3"/>
                      <xsl:variable name="var_LrnDelFAM_LDM4" select="@LearnDelFAM_LDM4"/>
