		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="LearningDelivery">
					...
					<xsl:variable name="var_ConRefStartDate" select="@ConRefStartDate"/>
					...
					<xsl:variable name="var_LARS_SectorSubjectAreaTier1" select="@LARS_SectorSubjectAreaTier1"/>
					<xsl:variable name="var_LARS_SectorSubjectAreaTier2" select="@LARS_SectorSubjectAreaTier2"/>
			...
			<entity>
				...
				<xsl:for-each select="EligibilityRule">
					<xsl:variable name="var_Benefits" select="@Benefits"/>
					<xsl:variable name="var_MaxAge" select="@MaxAge"/>
					<xsl:variable name="var_MaxLengthOfUnemployment" select="@MaxLengthOfUnemployment"/>
					<xsl:variable name="var_MaxPriorAttainment" select="@MaxPriorAttainment"/>
					<xsl:variable name="var_MinAge" select="@MinAge"/>
					<xsl:variable name="var_MinLengthOfUnemployment" select="@MinLengthOfUnemployment"/>
					<xsl:variable name="var_MinPriorAttainment" select="@MinPriorAttainment"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="EligibilityRuleEmploymentStatus">
					<xsl:variable name="var_EmploymentStatusCode" select="@EmploymentStatusCode"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="EligibilityRuleLocalAuthority">
					<xsl:variable name="var_LocalAuthorityCode" select="@LocalAuthorityCode"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="EligibilityRuleLocalEnterprisePartnership">
					<xsl:variable name="var_LocalEnterprisePartnershipCode" select="@LocalEnterprisePartnershipCode"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="EligibilityRuleSectorSubjectAreaLevel">
					<xsl:variable name="var_MaxLevelCode" select="@MaxLevelCode"/>
					<xsl:variable name="var_MinLevelCode" select="@MinLevelCode"/>
					<xsl:variable name="var_SectorSubjectAreaCode" select="@SectorSubjectAreaCode"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="ONSPostcode">
					<xsl:variable name="var_Doterm" select="@Doterm"/>
					<xsl:variable name="var_EffectiveFrom" select="@EffectiveFrom"/>
					<xsl:variable name="var_EffectiveTo" select="@EffectiveTo"/>
					<xsl:variable name="var_LEP1" select="@LEP1"/>
					<xsl:variable name="var_LEP2" select="@LEP2"/>
					<xsl:variable name="var_OSLAUA" select="@OSLAUA"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
