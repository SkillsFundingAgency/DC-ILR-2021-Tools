                      ...
                      <instance>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="LARS_StandardCommonComponent">
                            <xsl:variable name="var_LARSCommonComponent" select="@LARSCommonComponent"/>
                            <xsl:variable name="var_LARSEffectiveFrom" select="@LARSEffectiveFrom"/>
                            <xsl:variable name="var_LARSEffectiveTo" select="@LARSEffectiveTo"/>
                            <xsl:variable name="var_LARSStandardCode" select="@LARSStandardCode"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="LARS_StandardFunding">
                            <xsl:variable name="var_FundableWithoutEmployer" select="@FundableWithoutEmployer"/>
                            <xsl:variable name="var_SF1618Incentive" select="@SF1618Incentive"/>
                            <xsl:variable name="var_SFAchIncentive" select="@SFAchIncentive"/>
                            <xsl:variable name="var_SFCoreGovContCap" select="@SFCoreGovContCap"/>
                            <xsl:variable name="var_SFEffectiveFromDate" select="@SFEffectiveFromDate"/>
                            <xsl:variable name="var_SFEffectiveToDate" select="@SFEffectiveToDate"/>
                            <xsl:variable name="var_SFSmallBusIncentive" select="@SFSmallBusIncentive"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
