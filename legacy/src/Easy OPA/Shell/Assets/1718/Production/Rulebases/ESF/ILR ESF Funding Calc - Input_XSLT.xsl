								...
								<instance>
											...
											<instance>
												...
												<entity>
													...
													<xsl:for-each select="ESFData">
														<xsl:variable name="var_EffectiveContractEndDate" select="@EffectiveContractEndDate"/>
														<xsl:variable name="var_EffectiveContractStartDate" select="@EffectiveContractStartDate"/>
														<xsl:variable name="var_ESFDataPremiumFactor" select="@ESFDataPremiumFactor"/>
														<xsl:variable name="var_ESFDeliverableCode" select="@ESFDeliverableCode"/>
														<xsl:variable name="var_UnitCost" select="@UnitCost"/>
														<instance>
															<xsl:attribute name="id">
																<xsl:value-of select="generate-id(.)"/>
															</xsl:attribute>
												...
												<entity>
													...
													<xsl:for-each select="LearningDeliveryLARSFunding">
														<xsl:variable name="var_LARSFundingCategory" select="@LARSFundingCategory"/>
														<xsl:variable name="var_LARSFundingEffectiveFrom" select="@LARSFundingEffectiveFrom"/>
														<xsl:variable name="var_LARSFundingEffectiveTo" select="@LARSFundingEffectiveTo"/>
														<xsl:variable name="var_LARSFundingWeightedRate" select="@LARSFundingWeightedRate"/>
														<instance>
															<xsl:attribute name="id">
																<xsl:value-of select="generate-id(.)"/>
															</xsl:attribute>
												...
												<entity>
													...
													<xsl:for-each select="SFA_PostcodeAreaCost">
														<xsl:variable name="var_AreaCosEffectiveFrom" select="@AreaCosEffectiveFrom"/>
														<xsl:variable name="var_AreaCosEffectiveTo" select="@AreaCosEffectiveTo"/>
														<xsl:variable name="var_AreaCosFactor" select="@AreaCosFactor"/>
														<instance>
															<xsl:attribute name="id">
																<xsl:value-of select="generate-id(.)"/>
															</xsl:attribute>
									...
									<entity>
										...
										<xsl:for-each select="DPOutcome">
											...
											<xsl:variable name="var_OutCollDate" select="@OutCollDate"/>
											<xsl:variable name="var_OutEndDate" select="@OutEndDate"/>
