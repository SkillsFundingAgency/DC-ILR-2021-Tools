    ...
    <session-data>
      ...
      <entity>
        ...
        <xsl:for-each select="global">
          <xsl:variable name="var_ThirdSector" select="@ThirdSector"/>
          ...
          <instance>
            ...
            <entity>
              ...
              <xsl:for-each select="Learner">
                ...
                <xsl:variable name="var_EFA_CalcFundingLineType" select="@EFA_CalcFundingLineType"/>
                <xsl:variable name="var_EFA_CalcStartFunding" select="@EFA_CalcStartFunding"/>
                <xsl:variable name="var_EFA_CalcThresholdDays" select="@EFA_CalcThresholdDays"/>
                ...
                <instance>
                  ...
                  <entity>
                    ...
                    <xsl:for-each select="LearnerEmploymentStatus">
                      ...
                      <xsl:variable name="var_EmpStatMon_BSI" select="@EmpStatMon_BSI"/>
                      <xsl:variable name="var_EmpStatMon_EII" select="@EmpStatMon_EII"/>
                      <xsl:variable name="var_EmpStatMon_LOE" select="@EmpStatMon_LOE"/>
                      <xsl:variable name="var_EmpStatMon_LOU" select="@EmpStatMon_LOU"/>
                      <xsl:variable name="var_EmpStatMon_PEI" select="@EmpStatMon_PEI"/>
                      <xsl:variable name="var_EmpStatMon_SEI" select="@EmpStatMon_SEI"/>
                  ...
                  <entity>
                    ...
                    <xsl:for-each select="LearningDelivery">
                      ...
                      <xsl:variable name="var_ALB_CalcFundingLineType" select="@ALB_CalcFundingLineType"/>
                      <xsl:variable name="var_ALB_CalcStartFunding" select="@ALB_CalcStartFunding"/>
                      <xsl:variable name="var_CompStatus" select="@CompStatus"/>
                      <xsl:variable name="var_CreditBasedFwkType" select="@CreditBasedFwkType"/>
                      ...
                      <xsl:variable name="var_NotionalNVQLevel" select="@NotionalNVQLevel"/>
                      ...
                      <xsl:variable name="var_Section96Valid16to18" select="@Section96Valid16to18"/>
                      <xsl:variable name="var_SectorSubjectAreaTier1" select="@SectorSubjectAreaTier1"/>
                      <xsl:variable name="var_SectorSubjectAreaTier2" select="@SectorSubjectAreaTier2"/>
                      <xsl:variable name="var_SFA_CalcFundingLineType" select="@SFA_CalcFundingLineType"/>
                      <xsl:variable name="var_SFA_CalcLargeEmpFactor" select="@SFA_CalcLargeEmpFactor"/>
                      <xsl:variable name="var_SFA_CalcStartFunding" select="@SFA_CalcStartFunding"/>
                      <xsl:variable name="var_SFA_CalcThresholdDays" select="@SFA_CalcThresholdDays"/>
                      ...
                      <instance>
                        ...
                        <entity>
                          ...
                          <xsl:for-each select="LARSAnnualValue">
                            ...
                            <xsl:variable name="var_BasicSkillsParticipation" select="@BasicSkillsParticipation"/>
                            <xsl:variable name="var_BasicSkillsType" select="@BasicSkillsType"/>
                            <xsl:variable name="var_EffectiveFrom" select="@EffectiveFrom"/>
                            <xsl:variable name="var_EffectiveTo" select="@EffectiveTo"/>
                            ...
                            <xsl:variable name="var_SFAApprovalStatus" select="@SFAApprovalStatus"/>
                            <instance>
                              <xsl:attribute name="id">
                                <xsl:value-of select="generate-id(.)"/>
                              </xsl:attribute>
