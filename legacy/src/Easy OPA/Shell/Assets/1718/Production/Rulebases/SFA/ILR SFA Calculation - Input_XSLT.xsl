		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="LearningDeliveryLARS_Funding">
					...
					<xsl:variable name="var_LARSFundUnweightedRate" select="@LARSFundUnweightedRate"/>
					<xsl:variable name="var_LARSFundWeightedRate" select="@LARSFundWeightedRate"/>
					<xsl:variable name="var_LARSFundWeightingFactor" select="@LARSFundWeightingFactor"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="LargeEmployerReferenceData">
					<xsl:variable name="var_LargeEmpEffectiveFrom" select="@LargeEmpEffectiveFrom"/>
					<xsl:variable name="var_LargeEmpEffectiveTo" select="@LargeEmpEffectiveTo"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
			...
			<entity>
				...
				<xsl:for-each select="OrgFunding">
					<xsl:variable name="var_OrgFundEffectiveFrom" select="@OrgFundEffectiveFrom"/>
					<xsl:variable name="var_OrgFundEffectiveTo" select="@OrgFundEffectiveTo"/>
					<xsl:variable name="var_OrgFundFactor" select="@OrgFundFactor"/>
					<xsl:variable name="var_OrgFundFactType" select="@OrgFundFactType"/>
					<xsl:variable name="var_OrgFundFactValue" select="@OrgFundFactValue"/>
					<instance>
						<xsl:attribute name="id"><xsl:value-of select="generate-id(.)"/></xsl:attribute>
