          ...
          <instance>
            ...
            <entity>
              ...
              <xsl:for-each select="Learner">
                <xsl:variable name="var_AcadMonthPayment" select="@AcadMonthPayment"/>
                <xsl:variable name="var_FundLine" select="@FundLine"/>
                <xsl:variable name="var_LearnerActEndDate" select="@LearnerActEndDate"/>
                <xsl:variable name="var_LearnerPlanEndDate" select="@LearnerPlanEndDate"/>
                <xsl:variable name="var_LearnerStartDate" select="@LearnerStartDate"/>
                <xsl:variable name="var_LearnRefNumber" select="@LearnRefNumber"/>
                <xsl:variable name="var_OnProgPayment" select="@OnProgPayment"/>
                <instance>
                  <xsl:attribute name="id">
                    <xsl:value-of select="generate-id(.)"/>
                  </xsl:attribute>
