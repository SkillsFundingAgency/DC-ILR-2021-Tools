...
INNER JOIN  [${UoD.FullyQualified}].[${LARS.schemaname}].LARS_AnnualValue AV on L.LearnAimRef = AV.LearnAimRef
INNER JOIN  [${UoD.FullyQualified}].[${LARS.schemaname}].[LARS_Section96] S96 ON L.LearnAimRef=S96.LearnAimRef
