...
if object_id ('dbo.TransformInputToValid_LearnerDenormTbl','p') is not null
begin
	exec ('drop procedure dbo.TransformInputToValid_LearnerDenormTbl')
end
go
 
create procedure dbo.TransformInputToValid_LearnerDenormTbl as
begin
	insert Valid.LearnerDenormTbl (
		[UKPRN]
      ,[LearnRefNumber]
      ,[PrevLearnRefNumber]
      ,[PrevUKPRN]
