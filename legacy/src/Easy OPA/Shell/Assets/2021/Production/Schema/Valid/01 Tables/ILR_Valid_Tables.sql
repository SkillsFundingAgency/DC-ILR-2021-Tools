...
go
  if object_id('Valid.CollectionDetails', 'u') is not null begin drop table Valid.CollectionDetails
end
go
...
go
  if object_id('Valid.Source', 'u') is not null begin drop table Valid.[Source]
end
go
...
go
  if object_id('Valid.SourceFile', 'u') is not null begin drop table Valid.SourceFile
end
go
...
go
  if object_id('Valid.LearningProvider', 'u') is not null begin drop table Valid.LearningProvider
end
go
...
go
  if object_id('Valid.Learner', 'u') is not null begin drop table Valid.Learner
end
go
...
go
  if object_id('Valid.ContactPreference', 'u') is not null begin drop table Valid.ContactPreference
end
go
...
go
  if object_id('Valid.LLDDandHealthProblem', 'u') is not null begin drop table Valid.LLDDandHealthProblem
end
go
...
go
  if object_id('Valid.LearnerFAM', 'u') is not null begin drop table Valid.LearnerFAM
end
go
  create table Valid.LearnerFAM (
    ...
    LearnFAMCode int not null --primary key clustered(
    --	UKPRN asc,
    --	LearnRefNumber asc
    --)
  )
go
  create clustered index IX_Valid_LearnerFAM on Valid.LearnerFAM (LearnRefNumber asc)
go
  if object_id('Valid.ProviderSpecLearnerMonitoring', 'u') is not null begin drop table Valid.ProviderSpecLearnerMonitoring
end
go
...
go
  if object_id('Valid.LearnerEmploymentStatus', 'u') is not null begin drop table Valid.LearnerEmploymentStatus
end
go
...
go
  if object_id('Valid.LearnerEmploymentStatusDenormTbl', 'u') is not null begin drop table Valid.LearnerEmploymentStatusDenormTbl
end
go
...
go
  ...
  -- 	)
  -- go
  if object_id('Valid.EmploymentStatusMonitoring', 'u') is not null begin drop table Valid.EmploymentStatusMonitoring
end
go
...
go
  if object_id('Valid.LearnerHE', 'u') is not null begin drop table Valid.LearnerHE
end
go
...
go
  if object_id('Valid.LearnerHEFinancialSupport', 'u') is not null begin drop table Valid.LearnerHEFinancialSupport
end
go
...
go
  if object_id('Valid.LearningDelivery', 'u') is not null begin drop table Valid.LearningDelivery
end
go
...
go
  if object_id('Valid.LearningDeliveryDenormTbl', 'U') is not null begin drop table Valid.LearningDeliveryDenormTbl
end
go
...
go
  if object_id('Valid.LearnerDenormTbl', 'U') is not null begin drop table Valid.LearnerDenormTbl
end
go
...
go
  ...
  -- )
  -- go
  if object_id('Valid.LearningDeliveryFAM', 'u') is not null begin drop table Valid.LearningDeliveryFAM
end
go
  create table Valid.LearningDeliveryFAM (
    ...
    LearnDelFAMDateTo date null --primary key clustered(
    --	UKPRN asc,
    --	LearnRefNumber asc,
    --	AimSeqNumber asc
    --)
...
go
  if object_id('Valid.LearningDeliveryWorkPlacement', 'u') is not null begin drop table Valid.LearningDeliveryWorkPlacement
end
go
  create table Valid.LearningDeliveryWorkPlacement (
    ...
    WorkPlaceEmpId int null --primary key clustered(
    --	UKPRN asc,
    --	LearnRefNumber asc,
    --	AimSeqNumber asc
    --)
...
go
  if object_id('Valid.AppFinRecord', 'u') is not null begin drop table Valid.AppFinRecord
end
go
  create table Valid.AppFinRecord (
    ...
    AFinAmount int not null --primary key clustered(
    --		UKPRN asc,
    --		LearnRefNumber asc,
    --		AimSeqNumber asc,
    --		AFinType asc
...
go
  if object_id('Valid.ProviderSpecDeliveryMonitoring', 'u') is not null begin drop table Valid.ProviderSpecDeliveryMonitoring
end
go
...
go
  if object_id('Valid.LearningDeliveryHE', 'u') is not null begin drop table Valid.LearningDeliveryHE
end
go
...
go
  if object_id('Valid.LearnerDestinationandProgression', 'u') is not null begin drop table Valid.LearnerDestinationandProgression
end
go
...
go
  if object_id('Valid.DPOutcome', 'u') is not null begin drop table Valid.DPOutcome
end
go
  create table Valid.DPOutcome (
    ...
    OutCollDate date not null --primary key clustered(
    --	UKPRN asc,
    --	LearnRefNumber asc,
    --	OutType asc,
    --	OutCode asc,
...
go
  if object_id('Valid.File', 'u') is not null begin drop table Valid.[File]
end
go
  create table Valid.[File] (
    [UKPRN] int not null,
    [FileName] varchar(55) primary key([FileName] asc)
  )
INSERT INTO
  Valid.[File]
SELECT
