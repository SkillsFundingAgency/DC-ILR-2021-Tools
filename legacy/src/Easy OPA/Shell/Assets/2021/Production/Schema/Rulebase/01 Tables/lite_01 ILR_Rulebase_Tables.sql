...
go
  create table Rulebase.FM25_FM35_global (UKPRN int, RulebaseVersion varchar(10),)
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.FM25_FM35_Learner_PeriodisedValues
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.ALB_LearningDelivery_PeriodisedValues
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.FM35_LearningDelivery_PeriodisedValues
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.TBL_LearningDelivery_PeriodisedValues
end
go
...
go
  create table Rulebase.AEC_LearningDelivery_Period (
    ...
    LearnDelESFAContribPct decimal(12, 5),
    LearnSuppFund bit,
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.AEC_LearningDelivery_PeriodisedValues
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.AEC_LearningDelivery_PeriodisedTextValues
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.AEC_ApprenticeshipPriceEpisode_Period
end
go
...
go
  if object_id(
    ...
    'u'
  ) is not null begin drop table Rulebase.AEC_ApprenticeshipPriceEpisode_PeriodisedValues
end
go
