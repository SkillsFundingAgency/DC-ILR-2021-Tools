          ...
          select
            ...
            (
              ...
              where
                ULN = l.ULN 
                and UKPRN = l.UKPRN
                and [LatestInYear] = 1 for xml path ('HistoricEarningInput'),
                type
            ),
            (
              select
...
if object_id(
    'Rulebase.AEC_HistoricOutput_Copy',
    'p'
  ) is not null begin drop procedure Rulebase.AEC_HistoricOutput_Copy
end
go

CREATE PROCEDURE Rulebase.AEC_HistoricOutput_Copy
AS
BEGIN
